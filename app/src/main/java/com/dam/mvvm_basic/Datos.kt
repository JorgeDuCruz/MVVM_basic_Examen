 ...
 */
enum class EstadosAuxiliares(val txt: String, val funcion: (String)-> String) {
    AUX1(txt = "aux1", funcion = {msj -> msj}),
    AUX2(txt = "aux2", funcion = {msj -> msj.lowercase()}),
    AUX3(txt = "aux3", funcion = {msj -> msj.uppercase()}),
}
